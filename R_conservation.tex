...
\msb{This doesn't seem like it's really about multi-device usage}
...
\msb{this is a subsection of measurement, but doesn't seem related?}

%\msb{Same, remove "Studies show X" or "Researchers have found X". } \goli{done}

In this section, we will examine related studies in behavior change systems to develop testable hypotheses regarding the research question. \msb{what research question? if this is specific to a chapter rather than to the overall contributions, it should be in the relevant chapter}
...
\msb{same critique, this feels most relevant to a single chapter rather than to the thesis broadly}

\msb{without the motivation chapter, do you want choice architecture covered in RW at all?}
