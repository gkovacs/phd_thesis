...
%\msb{these figures are going nuts!!! can you fit them on the page?} \geza{done}

\begin{figure}
    \centering
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures2/browser_sankey_v7.png}
