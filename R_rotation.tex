...
\msb{the general role of a RW chapter is to cover the related work that sets up the context of your thesis. So, material that is relevant across all your chapters should show up here. Material that is specific to a single paper (e.g., rotation) should be in its respective chapter}

\msb{A section I don't see here, but should be here: a thorough survey of behavior change systems. What is the design space of such tools? What is the state of the art? How does HabitLab draw on those tools, and how does it innovate?}
...
\msb{I don't really see the point of section headers for so few paragraphs. instead, just use strong topic sentences}
...
\subsection{Socialtechnical Systems for Behavior Change}
...
\msb{This feels to me like it's a section that really belongs in the rotation chapter, not here --- it doesn't address the related work to the thesis broadly}
